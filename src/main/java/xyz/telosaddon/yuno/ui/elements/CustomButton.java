...
public class CustomButton extends AbstractCustomElement {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawStrokedRectangle(this.x, this.y, this.width, this.height, TelosAddon.CONFIG.borderColor());
        ...
        if(this.onToggle != null) {
            ...
            context.drawStrokedRectangle(boxX, boxY,  boxSize, boxSize, boxColor);
            if(toggled) {
