...
//
//        context.fill(this.x, this.y, this.x + this.width, this.y + this.height, CONFIG.fillColor());
//        context.drawBorder(this.x, this.y, this.width, this.height, CONFIG.borderColor());
//
//        String displayText = tr.trimToWidth(this.text, this.width - 8);
//        Text textFieldText = FontHelper.toCustomFont(displayText, CONFIG.font());
//
//        if(this.text.isEmpty() && !this.isFocused) {
//            Text placeHolderText = FontHelper.toCustomFont(this.placeHolderText,CONFIG.font());
...
//                Text startText = FontHelper.toCustomFont(displayText.substring(0, start), CONFIG.font());
//                Text endText = FontHelper.toCustomFont(displayText.substring(0, end), CONFIG.font());
...
//                Text cursorText = FontHelper.toCustomFont(displayText.substring(0, this.cursorPos), CONFIG.font());
